...
int main() {
    ...
    do {
        ...
        do {
            ...
            std::cout << "Apakah anda mau mengulang jumlah dan urutan keping? (ketik y untuk ya dan huruf lain untuk tidak): " << std::endl;
            std::cin >> pilihan1;

        } while (pilihan1 == 'y' || pilihan1 == 'Y');
        
        std::cout << "Apakah anda mau mengulang program? (ketik y untuk ya dan huruf lain untuk tidak): ";
        std::cin >> pilihan2;
